...
const $pxmu = {
    _init: function () {
        ...
        window.addEventListener('click', function (e) {
            ...
            if (e.target.dataset.pxmuCopyText) {
                // _this_.pxmulog(e.target.dataset.pxmuCopyText);
                let thiscopy = _this_.copy(e.target.dataset.pxmuCopyText);
                if (thiscopy) {
                    _this_.toast('复制成功');
                }
            }
    ...
    loading: function (msg) {
        var _this_ = this;
        _this_.addLoading('loading', msg);
    },

    success: function (msg) {
        var _this_ = this;
        _this_.addLoading('success', msg);
    },

    fail: function (msg) {
        var _this_ = this;
        _this_.addLoading('fail', msg);
    },
    ...
    diaglog: function (data) {
        ...
        choose(".pxmu-diag-item").onclick = function (e) {
            ...
            if (json.congif.cbcloseall === false && json.congif.cbclose === false && json.congif.anclose === true) {
                _this_.closediaglog(0, json.congif.animation);
                return false;
            };
    ...
    closediaglog: function (type = 0, outaniname = 'none') {
        ...
        _this_._close_html_diaglog(t, 'pxmu-diag-item', outaniname);
    },

    closeload: function (t = 0) {
        var _this_ = this;
        _this_._close_html_diaglog(t, 'pxmu-loading-item');
    },
    ...
    addLoading: function (type, json) {
        ...
        let loadType = _this_._pxmu_get_load_Type(type, htmls.color);
        if (!loadType) {
            return false;
        }
        ...
        if (htmls.close) {
            setTimeout(function () {
                ...
                setTimeout(function () {
                    ...
                    _this_.pxmulog(this_pxmuClassName);
